 ...
 export default function Sidebar({ users }: Props) {
   ...
   return (
     <div className="space-y-4">
       <div>
         <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Event / not-available scheduler</p>
       </div>
       ...
       {mode === "availability" ? (
         <div className="space-y-4">
           <div className="space-y-1">
             <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Add non-availability</h2>
             <p className="text-sm text-zinc-600 dark:text-zinc-400">Block out time you can’t make it.</p>
           </div>
         ...
         <div className="space-y-4">
           <div className="space-y-1">
             <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Create shared event</h2>
             <p className="text-sm text-zinc-600 dark:text-zinc-400">Invite people and coordinate.</p>
           </div>
           ...
           <div className="space-y-3">
             ...
             <div className="space-y-2">
               ...
               <div className="flex flex-wrap gap-2">
                 {availableInvitees.map((u) => (
                   <label
                     key={u.id}
                     className="flex items-center gap-2 rounded-md border border-zinc-200 bg-white px-3 py-1.5 text-sm text-zinc-900 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"
                   >
                     <input
                       type="checkbox"
             ...
             <p className="text-xs text-zinc-500 dark:text-zinc-400">Invited users will appear in attendee lists.</p>
           </div>
         </div>
       )}
     </div>
